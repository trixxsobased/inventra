                    ...
                    <form action="{{ route('petugas.borrowings.process-return', $borrowing->id) }}" method="POST">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="button" 
                                    ...
                                    onclick="event.preventDefault(); confirmAction(this.closest('form'), {title: 'Proses Pengembalian?', text: 'Pengembalian alat {{ $borrowing->equipment->name }} dari {{ $borrowing->user->name }} akan diproses sekarang.', icon: 'question', confirmButtonText: '<i class=\'bi bi-check-circle me-1\'></i> Ya, Proses', confirmButtonColor: '#059669'})">
