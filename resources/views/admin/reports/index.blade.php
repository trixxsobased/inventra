            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('admin.reports.generate', ['type' => 'borrowings', 'period' => 'week']) }}" 
                           target="_blank"
                           class="btn btn-outline-primary">
                            <i class="bi bi-calendar-week"></i> Peminjaman Minggu Ini
                        </a>
                        
                        <a href="{{ route('admin.reports.generate', ['type' => 'borrowings', 'period' => 'month']) }}" 
                           target="_blank"
                           class="btn btn-outline-primary">
                            <i class="bi bi-calendar-month"></i> Peminjaman Bulan Ini
                        </a>
                        
                        <a href="{{ route('admin.reports.generate', ['type' => 'fines', 'period' => 'month']) }}" 
                           target="_blank"
                           class="btn btn-outline-warning">
                            <i class="bi bi-cash"></i> Denda Bulan Ini
                        </a>
                        
                        <a href="{{ route('admin.reports.generate', ['type' => 'equipment', 'period' => 'year']) }}" 
                           target="_blank"
